    ...
    return (
        <div className="header">
            ...
            <div className='header_nav'>
                ...
                <div onChange={handelAuthentication} className="header_option">
